      ...
      if (response.ok) {
        ...
        movieDetailsContainer.innerHTML = `<div style="color: #fff; padding: 0px">
            <div class="container">
              <div class="row">
                <div class="col-md-4">
                  <img src="${movie.image}" alt="" class="img-fluid mb-4" style="max-width: 100%; height: 100%; object-fit: cover" />
                </div>
                <div class="col-md-8">
                  ...
                  <div class="container mt-4">
                      <div class="table-responsive">
                          <table class="table table-bordered">
                              ...
                              <tbody>
                                  ${Object.entries(movie.shows).flatMap(([date, showtimes]) =>showtimes.map((show, index) => `
                                      <tr>
                                          ${
                                            index === 0
